...
shared_ptr<Human> Factory::createJonSnow(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 100, /*money*/ 100);
}

shared_ptr<Human> Factory::createJaimeLannister(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 70, /*money*/ 180);
}

shared_ptr<Human> Factory::createDaenerys(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 110, /*money*/ 120);
}

shared_ptr<Human> Factory::createStannis(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 90, /*money*/ 130);
}

shared_ptr<Human> Factory::createJoffrey(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 75, /*money*/ 200);
}

shared_ptr<Human> Factory::createTheonGreyjoy(const string& name) {
    return make_shared<Human>(name, /*exp*/ 0, /*hp*/ 100, /*stamina*/ 85, /*money*/ 110);
}
